let showDebugDialogMessages = true;

export function disableDeduggingDialogs() {
	showDebugDialogMessages = false;
}

export function enableDebuggingDialogs() {
	showDebugDialogMessages = true;
}

let hasAddedAnvilleStyle = false;
...
export function createAppBar(normalButtonsIconsSrcsArray, contextualButtonsIconsSrcsArray, normalItemClickListener, contextualItemClickListener, createOptionsMenuBoolean, optionsStringsArray, optionsIconsSrcsArray, optionSelectedListener) {
...
export function turnOnContextualMode() {
...
export function turnOffContextualMode() {
	let appBar = document.getElementById("anvilleAppBar");
	if(appBar) {
...
export function createOptionsMenu(optionsStringsArray, optionsIconsSrcsArray, optionSelectedListener) {
	if(!hasAddedAnvilleStyle) {
		appendMenuAnvilleStyle();
		hasAddedAnvilleStyle = true;
	}
	...
	let toggleOptionsMenuButton = document.getElementById("anvilletoggleOptionsMenuButton");
...
export function addNewContextMenu(menuName, contextMenuButtonsStringsArray, contextMenuButtonsIconsSrcs, itemClickListener) {
	if(!hasAddedAnvilleStyle) {
		appendMenuAnvilleStyle();
		hasAddedAnvilleStyle = true;
	}
...
export function showContextMenu(menuName, referenceElement) {
...
export function hideContextMenu(menuName) {
	anvillebackgroundTint.click();
}

export function getContextMenu(menuName) {
	let contextMenu = document.getElementById("anvilleContextMenu" + menuName);
	if(!contextMenu) {
		console.error("INVALID MENU_NAME", "There is no context menu with menuName [" + menuName + "]");
		return;
...
export function addPopupMenu(menuTitle, menuName, popupMenuButtonsStringsArray, popupMenuButtonsIconsSrcs, itemClickListener) {
	if(!hasAddedAnvilleStyle) {
		appendMenuAnvilleStyle();
		hasAddedAnvilleStyle = true;
	}
...
export function showPopupMenu(menuName) {
...
export function customiseMenuStyle(menuStyle, menuButtonStyleNormal, menuButtonStyleHover, menuButtonStyleActive, menuTitleStyle) {
	if(!hasAddedAnvilleStyle) {
		appendMenuAnvilleStyle();
		hasAddedAnvilleStyle = true;
	}
...
export function customiseAppBarStyle(customAppBarStyleString, toggleOptionsMenuButtonColor) {
	if(!hasAddedAnvilleStyle) {
		appendMenuAnvilleStyle();
		hasAddedAnvilleStyle = true;
	}
...
export function showListFunctions() {
	if(showDebugDialogMessages) {
		if(!hasAddedAnvilleStyle) {
			appendMenuAnvilleStyle();
			hasAddedAnvilleStyle = true;
